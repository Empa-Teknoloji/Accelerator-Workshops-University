...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED2_Pin | LED3_Pin | LED5_Pin | LED6_Pin | LED7_Pin | LED8_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED2_Pin LED3_Pin LED5_Pin LED6_Pin
                           LED7_Pin LED8_Pin */
  GPIO_InitStruct.Pin = LED2_Pin | LED3_Pin | LED5_Pin | LED6_Pin | LED7_Pin | LED8_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
